...
fprintf('=== Training EfficientNetB0 (10 epochs) ===\n');
...
net_eff = trainNetwork(augTrain,lgraph,opts);
...
predLabels = classify(net_eff,augTest);
...
save( ...
    'TrainedModels/efficientnetb0_braintumor.mat', ...
    'net_eff', ...
    'classNames', ...
    'trueLabels', ...
    'predLabels', ...
...
fprintf('✓ TrainedModel saved: Models/efficientnetb0_braintumor.mat\n');
...
fprintf('\n=============================================================\n');
fprintf('              EFFICIENTNETB0 TRAINING COMPLETE\n');
fprintf('=============================================================\n');
...
fprintf('Model File          : TrainedModels/efficientnetb0_braintumor.mat\n');
