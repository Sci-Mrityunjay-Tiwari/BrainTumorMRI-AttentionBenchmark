...
fprintf('Loading VGG16...\n');

netBase = imagePretrainedNetwork("vgg16");
...
fprintf('=== Training VGG16 (10 epochs) ===\n');
...
net_vgg = trainNetwork(augTrain,lgraph,opts);
...
predLabels = classify(net_vgg,augTest);
...
save( ...
    'TrainedModels/vgg16_braintumor.mat', ...
    'net_vgg', ...
    'classNames', ...
    'trueLabels', ...
    'predLabels', ...
...
fprintf('✓ TrainedModel saved: Models/vgg16_braintumor.mat\n');
...
fprintf('\n=============================================================\n');
fprintf('                  VGG16 TRAINING COMPLETE\n');
fprintf('=============================================================\n');
...
fprintf('Model File          : TrainedModels/vgg16_braintumor.mat\n');
