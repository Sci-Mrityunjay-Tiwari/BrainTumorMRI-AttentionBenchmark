...
netBase = imagePretrainedNetwork("resnet50");
...
fprintf('=== Training ResNet50 (10 epochs) ===\n');
...
net_res = trainNetwork(augTrain,lgraph,opts);
...
predLabels = classify(net_res,augTest);
...
save( ...
    'TrainedModels/resnet50_braintumor.mat', ...
    'net_res', ...
    'classNames', ...
    'trueLabels', ...
    'predLabels', ...
...
fprintf('✓ TrainedModel saved: Models/resnet50_braintumor.mat\n');
...
fprintf('\n=============================================================\n');
fprintf('                 RESNET50 TRAINING COMPLETE\n');
fprintf('=============================================================\n');
...
fprintf('Model File          : TrainedModels/resnet50_braintumor.mat\n');
