fprintf('\n=== EfficientNet-ChannelAttention-Only (Ablation Study) ===\n\n');
...
fprintf('Adding Channel Attention Module...\n');
...
lastAttnLayer = 'channel_attention';

fprintf('✓ Channel Attention module added\n\n');
...
fprintf('=== Training EfficientNet-ChannelAttention-Only (10 epochs) ===\n');
...
net_ch_only = trainNetwork(augTrain,lgraph,opts);
...
predLabels = classify(net_ch_only,augTest);
...
save( ...
    'TrainedModels/efficientnet_ch_only_braintumor.mat', ...
    'net_ch_only', ...
    'classNames', ...
    'trueLabels', ...
    'predLabels', ...
...
fprintf('✓ TrainedModel saved: Models/efficientnet_ch_only_braintumor.mat\n');
...
fprintf('\n=============================================================\n');
fprintf('      EFFICIENTNET-CHANNEL ATTENTION TRAINING COMPLETE\n');
fprintf('=============================================================\n');
...
fprintf('Model File          : TrainedModels/efficientnet_ch_only_braintumor.mat\n');

fprintf('\n✓✓✓ EFFICIENTNET-CHANNEL ATTENTION COMPLETE ✓✓✓\n');
fprintf('Channel Attention Ablation Model Successfully Trained!\n\n');